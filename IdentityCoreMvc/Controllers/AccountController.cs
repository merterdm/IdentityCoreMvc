...
namespace IdentityCoreMvc.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginModel loginModel)
        {
            ...
            {
                var accessFaildResult = await userManager.AccessFailedAsync(user); // Eger Basarisiz giris yaptiysa bu degeri +1 arttiralim
                int yanlisgiris = await userManager.GetAccessFailedCountAsync(user); // Kullanicinin yanlis giris yatigi deneme sayisini aliyoruz
                if (yanlisgiris == 3)
                {
                    await userManager.SetLockoutEndDateAsync(user, DateTime.Now.AddMinutes(1));
                    ModelState.AddModelError("", "Arda Arda 2 kere yanlis giris yaptiniz. Hesabiniz 1 dakika kilitlenmistir.");
                ...
                else
                {
                    ...
                    if (result.IsLockedOut)
                        ...
                        ModelState.AddModelError("", "email yada sifre hatali");
        ...
        public async Task<IActionResult> Register(RegisterVM registerVM)
        {
            ...
            //                                <br />  
            //                                <a href='https://localhost:7217/MailKontrol/?uid={user.Id}&code={token}'>  
            //                                    Click here to Login  
            //                                </a>  
